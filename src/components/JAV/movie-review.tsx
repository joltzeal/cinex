...
export function MovieReviewDialog({ isOpen, review, onClose, onSubmit }: ReviewDialogProps) {
  ...
  useEffect(() => {
    ...
    setTags(review.tags.map((tag, index) => ({ id: String(index), text: tag })));
  }, [review]);
      ...
      <DialogContent className="sm:max-w-[425px]">
        ...
        <div className="grid gap-4 py-4">
          <div className="flex flex-col items-center gap-3">
            ...
            <Rating defaultValue={parseInt(rating)} onValueChange={(value) => setRating(value.toString())}>

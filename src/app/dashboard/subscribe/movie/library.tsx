...
export default function LibraryPage(props: pageProps) {
  ...
  const libraryMovieList = useMemo(() => {
    ...
    return filtered;
  }, [subscribeMovieList, hasSearched, filterType, ratingFilter, tagFilter, keywordFilter]);

  return (
    <div className="space-y-2">
      {/* 标题 */}
      <div>
        <h1 className="text-3xl md:text-4xl font-bold tracking-tight">已拥有影片</h1>
      ...
      <div className="max-w-4xl">
        <div className="flex flex-col sm:flex-row items-stretch sm:items-end gap-3">
          ...
          <div className="flex-shrink-0 w-full sm:w-[140px]">
            <label className="text-sm font-medium mb-2 block">筛选类型</label>
          ...
          <div className="flex-1 min-w-0 sm:max-w-md">
            <label className="text-sm font-medium mb-2 block">筛选条件</label>
            {filterType === 'rating' && (
          ...
          <div className="flex gap-2 flex-shrink-0">
            <Button onClick={handleSearch} className="gap-2 flex-1 sm:flex-initial">
